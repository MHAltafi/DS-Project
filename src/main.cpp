...
int main()
{
    ...
    a.setnewedge(a.getnode("Shandiz Haji"),a.getnode("Mofatteh Square"),"Molla Jalil Alley",0.2,1,0);
    a.setnewedge(a.getnode("Shandiz Haji"),a.getnode("Imam Square"),"Shandiz to Imam Sq Alley",0.2,3,1);
    a.setnewedge(a.getnode("Shandiz Haji"),a.getnode("Takhti Bridge"),"Shandiz to Takhti Bridge Alley",0.2,1,2);
    ...
    a.setnewedge(a.getnode("Shariati 4-way"),a.getnode("Shariati Square"),"Khajeh Rashid Blvd",0.1,3,11);
